...
public class PlayerAgent : Agent
{
    ...
    FoodArea m_FoodArea;
    public float SpwanRange = 11f;
    public float meatReward = 1f;
    public float carrotReward = -0.5f;
    ...
    {
        m_Forward = Math.Clamp(vectorAction.ContinuousActions[0], -1f, 1f);
        m_Rotate = Math.Clamp(vectorAction.ContinuousActions[1], -1f, 1f);
    ...
    public override void OnEpisodeBegin()
    {
        ...
        transform.localPosition = new Vector3(UnityEngine.Random.Range(-SpwanRange, SpwanRange), 0.5f, UnityEngine.Random.Range(-SpwanRange, SpwanRange));
